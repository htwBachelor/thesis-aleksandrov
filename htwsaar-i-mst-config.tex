...
% ****************************************************************************************************
\newcommand{\myTitle}{Migration eines webbasierten Bestellungssystems in eine .Net-Umgebung mit Umbraco Content-Management Funktionalität}
...
\newcommand{\myName}{Bozhidar Aleksandrov\xspace}
\newcommand{\myUni}{Hochschule für Technik und Wirtschaft des Saarlandes\xspace}
\newcommand{\myCompany}{EmRoLab der Hochschule für Technik und Wirtschaft des Saarlandes\xspace}
\newcommand{\myFirstProf}{Prof. Dr. Helmut Folz\xspace}
\newcommand{\mySecondProf}{Thomas Beckert, M.Sc.\xspace}
\newcommand{\myLocation}{Saarbrücken\xspace}
\newcommand{\myTime}{30.~September~2018\xspace}
